...
#define tire_radius_cm_default  3.25f			 //轮胎半径，单位为cm
#define pulse_cnt_per_circle_default  1456 //实际轮子转动一周的脉冲数量 530 1080 40750
...
/***********************************************************************************************************************/
#define speed_expect_default 			40.0f			//自主寻迹时，速度默认设定值
#define work_mode_default   			0 				//小车工作模式出厂默认值



/***********************************************************************************************************************/
#define turn_kp_default1						40.0f 	//基于红外对管识别轨迹时,自主寻迹的位置控制器比例参数KP	
#define turn_ki_default1						0.0f		//基于红外对管识别轨迹时,自主寻迹的位置控制器积分参数KI	
#define turn_kd_default1						0			//基于红外对管识别轨迹时,自主寻迹的位置控制器微分参数KD	
#define turn_scale_default        	0.12f		//转向控制器输出转换到轮子期望差速时的量程转换系数
...
/***********************************************************************************************************************/
#define steer_gyro_kp_default  		0.4f			//转向陀螺仪控制时，角速度内环比例系数KP-1.5
#define steer_gyro_ki_default  		0.04f			//转向陀螺仪控制时，角速度内环积分系数KI-0
#define steer_gyro_kd_default  		0.0f			//转向陀螺仪控制时，角速度内环微分系数KD-3	
...
/***********************************************************************************************************************/
#define speed_kp_default  				35.0f			//速度控制器比例参数KP
#define	speed_ki_default					0.70f			//速度控制器积分参数KI
